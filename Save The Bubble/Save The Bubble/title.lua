...
function scene:create( event )
	...
	background = display.newImageRect( sceneGroup, "default.png", display.contentWidth + display.contentWidth/8, display.contentHeight )
	background.x = display.contentWidth/2;
	background.y = display.contentHeight/2;
	
	-- Add more text
	local pageText = display.newText( "[ Touch screen to continue ]", 0, 0, native.systemFont, 30 )
